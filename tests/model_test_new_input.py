...
#Additional code to save answer embeddings
'''#create embeddings for correct answers
correct_answers = pd.read_csv("C://Users//Shashank//OneDrive//Documents//DSDM//Automatic Scoring App//Data//correct_answers.csv", sep=';')
...
#save answer_embeddings
with open('Correct_Answers_Embeddings.pickle', "wb") as f:
